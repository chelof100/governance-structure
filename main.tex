...
\begin{tabular}{lll}
\toprule
\textbf{Paper} & \textbf{Title} & \textbf{DOI / arXiv} \\
\midrule
P0 & Atomic Decision Boundaries & DOI: 10.5281/zenodo.19670649; arXiv: 2604.17511 \\
P1 & Agent Control Protocol (ACP) & DOI: 10.5281/zenodo.19672575; arXiv: 2603.18829 \\
P2 & From Admission to Invariants (IML) & DOI: 10.5281/zenodo.19672589; arXiv: 2604.17517 \\
P3/P4 & \textit{Irreducible Governance Structure} (this paper) & DOI: 10.5281/zenodo.19672597 + 10.5281/zenodo.19672608 \\
P5 & Reconstructive Authority Model (RAM) & DOI: 10.5281/zenodo.19669430 \\
P6 & Operationalizing Reconstructive Authority & DOI: 10.5281/zenodo.19699460 \\
\bottomrule
\end{tabular}
\end{table}
...
Conversely, under-service (e.g., an agent's allocation is artificially restricted) inflates detection delay: fewer samples of the agent's behavior increase estimation error, making genuine drift harder to detect. By Corollary of Theorem~\ref{thm:bias-drift}, detection delay is amplified by $(1 - \delta N)^{-1}$ under under-service, and approaches infinity as starvation becomes complete.
...
Figure~\ref{fig:ablation} shows fraction of trials satisfying each guarantee P1--P4 for each layer subset.
...
\begin{quote}
\textit{Admission control determines what can happen. Fair allocation determines who gets to act. Correctness is local. Fairness is global. Both are necessary for governed autonomy.}
\end{quote}
